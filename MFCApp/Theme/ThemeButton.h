/****************************************************************/
/*																*/
/*		FILE NAME		:	ThemeButton.h						*/
/*		DISCRIPTION		:	Theme Button Skin Control Class		*/
/*																*/
...
#if !defined(AFX_THEMEBUTTON_H__6C978DF5_08E5_4D67_ADD5_D1BF31084757__INCLUDED_)
#define AFX_THEMEBUTTON_H__6C978DF5_08E5_4D67_ADD5_D1BF31084757__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// ThemeButton.h : header file
//
...
#define dfWM_BTN_MOUSE_MOVE						WM_USER+108				// 버튼 컨트롤 마우스 이동 메세지
#define dfWM_BTN_LBUTTON_DOWN					WM_USER+109				// 버튼 컨트롤 마우스 왼쪽 버튼 클릭 다운 메세지
#define dfWM_BTN_LBUTTON_UP						WM_USER+110				// 버튼 컨트롤 마우스 왼쪽 버튼 클릭 해제 메세지
#define dfWM_BTN_LBUTTON_DBLCLK					WM_USER+111				// 버튼 컨트롤 마우스 왼쪽 버튼 더블 클릭 메세지

/////////////////////////////////////////////////////////////////////////////
// CThemeButton window

class CThemeButton : public CButton
{
// Construction
public:
	const static enum {
	...
	static struct ST_THEME_BUTTON_INFO
	{
...
// Attributes
public:
	ST_THEME_BUTTON_INFO	m_stThemeInfo;
...
public:
	...
	virtual ~CThemeButton();

	// Generated message map functions
protected:
	//{{AFX_MSG(CThemeButton)
...
#endif // !defined(AFX_THEMEBUTTON_H__6C978DF5_08E5_4D67_ADD5_D1BF31084757__INCLUDED_)
